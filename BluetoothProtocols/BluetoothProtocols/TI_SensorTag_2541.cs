...
namespace BluetoothProtocols
{
    ...
    /// This class was automatically generated 2022-12-08::12:48
    /// </summary>
    ...
    public partial class TI_SensorTag_2541 : INotifyPropertyChanged
    {
        ...
        public enum CharacteristicsEnum {
            ...
            Accelerometer_Configure_Accelerometer_enum = 1,
            Accelerometer_Period_Accelerometer_enum = 2,
            Key_Press_State_Key_Press_enum = 3,
            IR_Data_IR_Service_enum = 4,
            IR_Service_Configure_IR_Service_enum = 5,
            IR_Service_Period_IR_Service_enum = 6,
            Humidity_Data_Humidity_enum = 7,
            Humidity_Configure_Humidity_enum = 8,
            Humidity_Period_Humidity_enum = 9,
            Magnetometer_Data_Magnetometer_enum = 10,
            Magnetometer_Configure_Magnetometer_enum = 11,
            Magnetometer_Period_Magnetometer_enum = 12,
            Barometer_Data_Barometer_enum = 13,
            Barometer_Configure_Barometer_enum = 14,
            Barometer_Calibration_Barometer_enum = 15,
            Barometer_Period_Barometer_enum = 16,
            Gyroscope_Data_Gyroscope_enum = 17,
            Gyroscope_Configure_Gyroscope_enum = 18,
            Gyroscope_Period_Gyroscope_enum = 19,
            Device_Name_Common_Configuration_enum = 20,
            Appearance_Common_Configuration_enum = 21,
            Privacy_Common_Configuration_enum = 22,
            Reconnect_Address_Common_Configuration_enum = 23,
            Connection_Parameter_Common_Configuration_enum = 24,
