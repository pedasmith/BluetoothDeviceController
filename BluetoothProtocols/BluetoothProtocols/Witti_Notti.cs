...
namespace BluetoothProtocols
{
    /// <summary>
    /// .
    /// This class was automatically generated 2022-12-10::07:39
    /// </summary>
    ...
    public partial class Witti_Notti : INotifyPropertyChanged
    {
        ...
        Guid[] CharacteristicGuids = new Guid[] {
            ...
            Guid.Parse("00002a29-0000-1000-8000-00805f9b34fb"), // #6 is ManufacturerManufacturer Name
        ...
        String[] CharacteristicNames = new string[] {
            ...
            "ManufacturerManufacturer Name", // #6 is 00002a29-0000-1000-8000-00805f9b34fb
        ...
        private string _ManufacturerManufacturer_Name = "";
        private bool _ManufacturerManufacturer_Name_set = false;
        public string ManufacturerManufacturer_Name
        {
            get { return _ManufacturerManufacturer_Name; }
            internal set { if (_ManufacturerManufacturer_Name_set && value == _ManufacturerManufacturer_Name) return; _ManufacturerManufacturer_Name = value; _ManufacturerManufacturer_Name_set = true; OnPropertyChanged(); }
        }
        ...
        public async Task<BCBasic.BCValueList> ReadManufacturerManufacturer_Name(BluetoothCacheMode cacheMode = BluetoothCacheMode.Uncached)
        {
            ...
            var datameaning = "STRING|ASCII";
            var parseResult = BluetoothDeviceController.BleEditor.ValueParser.Parse(result, datameaning);
            ManufacturerManufacturer_Name = parseResult.ValueList.GetValue("param0").AsString;
        ...
        public async Task<bool> NotifyUnknown3Async(GattClientCharacteristicConfigurationDescriptorValue notifyType = GattClientCharacteristicConfigurationDescriptorValue.Notify)
        {
            ...
            try
            {
                ...
                if (!NotifyUnknown3_ValueChanged_Set)
                {
                    ...
                    ch.ValueChanged += NotifyUnknown3Callback;
                }
        ...
        private void NotifyUnknown3Callback(GattCharacteristic sender, GattValueChangedEventArgs args) 
        {
        ...
        public void NotifyUnknown3RemoveCharacteristicCallback() 
        {
            var ch = Characteristics[(int)CharacteristicsEnum.Unknown3_LED_Control_enum];
            if (ch == null) return;
            NotifyUnknown3_ValueChanged_Set = false;
            ch.ValueChanged -= NotifyUnknown3Callback;
        }
