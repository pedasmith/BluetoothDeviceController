...
namespace BluetoothProtocols
{
    /// <summary>
    /// .
    /// This class was automatically generated 2025-01-28::21:17
    /// </summary>

    public  class DaybetterLED : INotifyPropertyChanged
    {
        ...
        /// <returns></returns>
        public async Task<GattCommunicationStatus> WriteModbusSend(byte Address, byte Command, byte[] Result, UInt16 Crc)
        {
        ...
        private double _ModbusReply_Command = 0;
        private bool _ModbusReply_Command_set = false;
        public double ModbusReply_Command
        {
            get { return _ModbusReply_Command; }
            internal set { if (_ModbusReply_Command_set && value == _ModbusReply_Command) return; _ModbusReply_Command = value; _ModbusReply_Command_set = true; OnPropertyChanged(); }
        }
        ...
        public async Task<BCBasic.BCValueList> ReadModbusReply(BluetoothCacheMode cacheMode = BluetoothCacheMode.Uncached)
        {
            ...
            var datameaning = "U8|HEX|Address U8|HEX|Command BYTES|HEX|Result U16|HEX|Crc";
            var parseResult = BluetoothDeviceController.BleEditor.ValueParser.Parse(result, datameaning);
            ModbusReply_Address = parseResult.ValueList.GetValue("Address").AsDouble;
            ModbusReply_Command = parseResult.ValueList.GetValue("Command").AsDouble;
