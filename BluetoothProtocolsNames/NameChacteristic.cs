...
//using System.Text.Json; // replacing NewtonSoft
using System.Text.Json.Serialization;
// Old Location: BluetoothProtocols/Names. New location: BluetoothProtocolsNames
...
namespace BluetoothProtocolsNames
{
    ...
    public class NameCharacteristic
    {
        ...
        public NameCharacteristic(GattCharacteristic characteristic, NameService service, NameCharacteristic defaultCharacteristic, int count = -1)
        {
            ...
            DataGroupName = (service?.Name ?? "SERVICE") + "_Data"; // Actually set in the BtJsonToMacro
