...
3. Add a link to the Help.md file ** [[[DeviceName]]](Device_[[CLASSNAME]].md) **
4. Add a link to the Welcome.md file ** [![[[DeviceName]]](../DevicePictures/[[CLASSNAME]]-175.png)](Device_[[CLASSNAME]].md) **
...
3. Add the specialization to  **mainpage.xaml.cs** about line 90-135 add a specialization line like ```            new Specialization (typeof(SpecialtyPages.[[CLASSNAME]]Page), new string[] { "[[NAME]]" }, HEALTH, "**maker**", "**device type**"),```
4. Compile and run!
...
# The [[DeviceName]] **type of device like toy, robot, sensor**

![Robot](../DevicePictures/[[CLASSNAME]]-175.png)
