...
namespace BluetoothProtocols
{
    ...
    // Link: https://github.com/glmck13/VitalBlues/blob/master/samico-bp.sh
        ...
        public enum CharacteristicsEnum {
            ...
            System_ID_Device_Info_enum = 1,
            Model_Number_Device_Info_enum = 2,
            Serial_Number_Device_Info_enum = 3,
            Firmware_Revision_Device_Info_enum = 4,
            Hardware_Revision_Device_Info_enum = 5,
            Software_Revision_Device_Info_enum = 6,
            Manufacturer_Name_Device_Info_enum = 7,
            Results_BloodPressure_enum = 8,
            BatteryLevel_Battery_enum = 9,
        ...
        {
            if (!await EnsureCharacteristicAsync(CharacteristicsEnum.Results_BloodPressure_enum)) return false;
            var ch = Characteristics[(int)CharacteristicsEnum.Results_BloodPressure_enum];
