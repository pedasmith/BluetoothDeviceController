...
REM %BIN% -inputJsonFile "%JSONDIR%"\ChoiceMMed_PulseOximeter.json -inputTemplates Templates -output output
REM %BIN% -inputJsonFile "%JSONDIR%"\BTStandard_Cycling_Speed_Cadence.json -inputTemplates Templates -output output
REM %BIN% -inputJsonFile "%JSONDIR%"\BTStandard_Demo.json -inputTemplates Templates -output output
REM %BIN% -inputJsonFile "%JSONDIR%"\BTStandard_Heart_Rate.json -inputTemplates Templates -output output
REM %BIN% -inputJsonFile "%JSONDIR%"\Nordic_Thingy.json -inputTemplates Templates -output output
REM %BIN% -inputJsonFile "%JSONDIR%"\Viatom_PC60FW_PulseOximeter.json -inputTemplates Templates -output output
goto :EOF
